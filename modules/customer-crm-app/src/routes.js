...
const ListOfModules = React.lazy(() => import('./ListModules/components/ListOfModules'));
...
const routes = [
  ...
  { path: '/listOfModules', name: 'ListOfModules', component: ListOfModules },
  ...
  { path: '/CustomerTable', name: 'CustomerTable', component: CustomerTable },
