...
describe('classNames', function () {
  ...
  xit('should be fast as classnames +- 100 ops/sec', function () {
    return new Promise(function (resolve, reject) {
      ...
      suite.add('classNames', function () {
        classNames.apply(void 0, args);
      }).add('cx', function () {
        cx.apply(void 0, args);
      }).on('cycle', function (event) {
        console.log(String(event.target));
      }).on('complete', function () {
        // console.log(`Fastest is ${this.filter('fastest').map('name')}`);
        var classNamesOps = this['0'].hz;
        var cxOps = this['1'].hz;
        ...
        reject("cx is about ".concat(Math.round(classNamesOps / cxOps), " times slower"));
      }).run();
    });
  });
});