...
following in their [`src/index.js`](modules/customer-crm-app/src/index.js) file:
...
1. Service workers are [not supported](https://jakearchibald.github.io/isserviceworkerready/#moar)
   in older web browsers. Service worker registration [won't be attempted](modules/customer-crm-app/src/registerServiceWorker.js)
...
1. Users aren't always familiar with offline-first web apps. It can be useful to
   ...
   starting point, you can make use of the logic included in [`src/registerServiceWorker.js`](modules/customer-crm-app/src/registerServiceWorker.js), which
...
[`public/manifest.json`](modules/customer-crm-app/public/manifest.json), that you can customize with
details specific to your web application.

When a user adds a web app to their homescreen using Chrome or Firefox on
Android, the metadata in [`manifest.json`](modules/customer-crm-app/public/manifest.json) determines what
...
When users install your app to the homescreen of their device the default configuration will make a shortcut to `/index.html`. This may not work for client-side routers which expect the app to be served from `/`. Edit the web app manifest at [`public/manifest.json`](modules/customer-crm-app/public/manifest.json) and change `start_url` to match the required URL scheme, for example:
